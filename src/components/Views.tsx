         ...
         <div className="flex items-center gap-4">
            ...
            {selectedIds.length > 0 && (
                <div className="flex items-center gap-2 bg-blue-900/20 px-3 py-1.5 rounded-full border border-blue-900/50">
                    ...
                    {onBulkDelete && <button onClick={(e) => { e.stopPropagation(); onBulkDelete(selectedIds); setSelectedIds([]); }} className="ml-2 p-1 text-red-400 hover:text-red-300 hover:bg-red-900/30 rounded"><Trash2 size={16} /></button>}
                </div>
            )}
         </div>
